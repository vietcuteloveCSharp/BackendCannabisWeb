...
{
	public class TestForgotPassword_Logic :IClassFixture<CannabisWebApplicationFactory>
	{
		private readonly HttpClient _client;
		private readonly FakeRedisService _fakeRedis;

		public TestForgotPassword_Logic(CannabisWebApplicationFactory factory)
		{
