namespace Service.Implementations.UserManagement
{
	public class UserService:IUserService
	{
		...
		{   //check null input
			...
			var userRole = await _unitOfWork.Roles.GetByNameAsync("Customer");
			if (userRole == null)
			{
				throw new InvalidOperationException("Role 'Customer' chưa tồn tại trong DB");
			}
			var userStatus = await _unitOfWork.userStatus.GetCodeAsync("Active");
			//DTO-> Entity
			...
			userEntity.StatusId = userStatus!.Id;
